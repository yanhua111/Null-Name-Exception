...
export default class LoginScreen extends React.Component {
  componentDidMount () {
    ...
    async loginWithFb () {
      try {
        // face book login
        const { type, token } = await Facebook.logInWithReadPermissionsAsync('520578628732460', { permissions: ['public_profile'] });
        ...
        const apptoken = await Notifications.getExpoPushTokenAsync();
        if (type == 'success') {
